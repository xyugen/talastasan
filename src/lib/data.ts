import ImpengNegro from '$lib/assets/written-works/impeng-negro.png?url';
import TataSeto from '$lib/assets/written-works/tata-seto.png?url';
import Pagsalunga from '$lib/assets/written-works/pagsalunga.png?url';
import DugoSaBukangLiwayway from '$lib/assets/written-works/dugo-sa-bukang-liwayway.png?url';

import BuongKuwento from '$lib/assets/stories/buong-kuwento.png?enhanced';
...
import type { StoryChapter } from '../interface/StoryChapter';
...
export const fullStoryChapters: StoryChapter[] = [
	{
		title: 'Pahina 1',
		link: '/pahina-1',
...
export const stories = [
	...
	},
	{
		...
		link: '/kuwentong-may-larawan',
		title: 'Kuwentong May Larawan',
		description: 'Tingnan ang detalyadong pangyayari sa pamamagitan ng mga larawan.'
	}
];

export const shortenedStory = `Si Impen, isang binatilyong may maitim na balat, ay laging biktima ng panunukso at diskriminasyon sa kanilang lugar. Tinatawag siyang "Negro" dahil sa kanyang kulay at pamilyang pinagmulan—isang anak ng sundalong Negro na iniwan sila matapos siyang ipanganak. Ang kanyang ina ay naglalabada noon para sa ikabubuhay nila ngunit dahil sa mga pangyayari sa kanilang pamilya at mapanghusgang komunidad na kanilang kinabibilangan ay natigil ito at napilitang magtrabaho si Impen bilang isang agwador. Ang kanyang ina ay madalas siyang pinapayuhan na umiwas sa gulo, lalo na sa mga basagulerong tulad ni Ogor na isa rin sa mga agwador na may malusog at matipunong pangangatawan. 

Sa araw na iyon, habang nakapila si Impen sa poso upang mag-igib, sinimulan na naman ni Ogor ang panunukso. Sa simula hindi niya ito pinansin ngunit sa kalaunan, inabuso ni Ogor ang pagpapasensiya niya—pinatid, sinaktan, at ipinahiya. Sa gitna ng sakit, poot, at pag-aalipusta, nag-alab ang damdamin ni Impen. Nang tuluyang hindi makatiis, nilabanan niya si Ogor. Nagkaengkwentro sila at sa pagkakataong iyon, nailabas ni Impen ang lahat ng hinanakit at galit mula sa mga pang-aaping natamo.

Sa huli, si Impen ay nanindigan laban kay Ogor at sa simbolo ng diskriminasyong kanyang nararanasan. Ang kuwento ay nagtatapos na nagpapahiwatig ng tagumpay ni Impen laban sa pisikal at emosyonal na pang-aabuso, ngunit ito rin ay nagpapakita ng isang mas malalim na komentaryo tungkol sa kahirapan, pagkakakulong sa diskriminasyon, at ang hangaring makamit ang dignidad para sa pamilya at sarili.`;
